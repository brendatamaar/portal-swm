...
class CreateSampling7sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sampling7s', function (Blueprint $table) {
            $table->id();$table->string('site_id');
    ...
    {
        Schema::dropIfExists('sampling7s');
    }
}
